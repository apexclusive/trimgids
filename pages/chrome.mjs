...
export const chromeCssLink = '<link rel="stylesheet" href="/assets/css/site-chrome.css?v=23" id="tg-site-chrome">';
...
<div class="home-newsletter" id="tg-newsletter" data-tg-newsletter>
  <div class="home-newsletter-in">
    <div class="wrap" style="padding:0">
      <strong>Wekelijkse tips &amp; deals voor je hond</strong>
  ...
  <div class="wrap">
    ...
    <div class="footer-grid">
      ...
      <div class="footer-col">
        ...
        <ul>
          <li><a href="/forum">Forum voor baasjes</a></li>
