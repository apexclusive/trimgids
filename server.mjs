...
.mobile-bottom-bar{display:none;position:fixed;bottom:0;left:0;right:0;background:rgba(255,255,255,.98);border-top:1px solid var(--line);padding:8px 12px;z-index:99;backdrop-filter:blur(10px);box-shadow:0 -4px 16px rgba(0,0,0,.08);justify-content:space-around;align-items:center}
.mobile-bottom-bar a{display:flex;flex-direction:column;align-items:center;gap:3px;font-size:11px;font-weight:700;color:var(--muted);text-decoration:none}
.mobile-bottom-bar a.active,.mobile-bottom-bar a:hover{color:var(--green)}
.mobile-bottom-bar .m-ico{font-size:18px;line-height:1}
@media(max-width:840px){.mobile-bottom-bar{display:flex}body{padding-bottom:65px}}
